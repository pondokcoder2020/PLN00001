    ...
    <div class="table-responsive">
        <table id="example" class="table table-bordered table-striped table-hover" style="width:100%" >
            ...
            <tbody>
                <?php
                $no=1;
                $tampil=pg_query($conn,"SELECT a.*,b.nama as varian,c.nama as kapasitas FROM master_aset_subkategori_identitas a LEFT JOIN master_aset_subkategori_varian b ON a.id_varian=b.id LEFT JOIN kapasitas c ON a.kapasitas=c.id WHERE a.id_subkategori='$_GET[id]' ORDER BY a.nama ASC");
