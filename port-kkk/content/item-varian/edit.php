<?php
$d=pg_fetch_array(pg_query($conn,"SELECT * FROM master_item_varian WHERE uid='$_POST[id]'"));
?>
<form action="aksi-edit-item-varian" method="POST" enctype="multipart/form-data">
