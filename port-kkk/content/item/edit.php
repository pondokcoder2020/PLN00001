<?php
$d=pg_fetch_array(pg_query($conn,"SELECT * FROM master_item WHERE uid='$_POST[id]'"));
?>
<form action="aksi-edit-item" method="POST" enctype="multipart/form-data">
		...
		<div class="modal-content">
			...
			<div class="modal-body" id="form-data">
				<div class="form-group focused row">
					<label class="form-control-label col-md-3 pt-2">Nama Item</label>
					<div class="col-md-9">
				...
				<div class="form-group focused row">
					...
					<div class="col-md-9">
						<input type="text" class="form-control form-control-alternative" placeholder="" value="<?php echo $d['satuan'];?>" name="satuan">
					</div>
				</div>
			</div>
