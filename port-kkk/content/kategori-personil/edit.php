<?php
$d=pg_fetch_array(pg_query($conn,"SELECT * FROM master_kategori_personil WHERE uid='$_POST[id]'"));
?>
<form action="aksi-edit-kategori-personil" method="POST" enctype="multipart/form-data">
		...
		<div class="modal-content">
			...
			<div class="modal-body" id="form-data">
				<div class="form-group focused row">
					<label class="form-control-label col-md-3 pt-2">Nama Kategori</label>
					<div class="col-md-9">
