<?php
$d=pg_fetch_array(pg_query($conn,"SELECT * FROM master_klasifikasi WHERE uid='$_POST[id]'"));
?>
<form action="aksi-edit-klasifikasi" method="POST" enctype="multipart/form-data">
