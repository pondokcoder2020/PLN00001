<?php
$d=pg_fetch_array(pg_query($conn,"SELECT * FROM master_aset_kategori WHERE id='$_POST[id]'"));
?>
<form action="aksi-edit-master-inspeksi-peralatan" method="POST" enctype="multipart/form-data">
