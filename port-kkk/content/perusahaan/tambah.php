<form action="aksi-tambah-perusahaan" method="POST" enctype="multipart/form-data">
		...
		<div class="modal-content">
			...
			<div class="modal-body" id="form-data">
                <div class="form-group focused row">
					...
					<div class="col-md-9">
						<input type="text"  class="form-control form-control-alternative" placeholder="" name="nama_perusahaan" autofocus>
					</div>
				</div>
				<div class="form-group focused row">
					<label class="form-control-label col-md-3 pt-2">Jenis Perusahaan</label>
					<div class="col-md-9">
						<input type="text"  class="form-control form-control-alternative" placeholder="" name="jenis_perusahaan" required>
					</div>
				</div>
				<div class="form-group focused row">
