<?php
$d=pg_fetch_array(pg_query($conn,"SELECT * FROM master_pegawai_bidang WHERE uid='$_POST[id]'"));
?>
<form action="aksi-edit-bidang" method="POST" enctype="multipart/form-data">
