<form action="aksi-tambah-bidangsektor" method="POST" enctype="multipart/form-data">
		...
		<div class="modal-content">
			...
			<div class="modal-body" id="form-data">
                <div class="form-group focused">
                    ...
                    <input type="text"  class="form-control form-control-alternative" placeholder="Bidang" name="nama" autofocus required>
                </div>
			</div>
