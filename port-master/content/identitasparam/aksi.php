...
if (empty($_SESSION['login_user'])){
	...
	elseif($act=='inputparameter'){
		...
		$sql="INSERT INTO master_aset_subkategori_parameter (nama,id_kategori,id_subkategori,created_at) VALUES ('$_POST[nama]','$rx[id_kategori]','$_POST[id_subkategori]','$waktu_sekarang')";
	...
	elseif ($act=='updateidentitas'){
		...
		$tgl=date('Y-m-d',strtotime($_POST['tanggal_beli']));
		$sql="UPDATE master_aset_subkategori_identitas SET nama='$_POST[nama]',merk='$_POST[merk]',kapasitas='$_POST[kapasitas]',jumlah='$_POST[jumlah]',satuan='$_POST[satuan]',keterangan='$_POST[keterangan]',tanggal_beli='$tgl',lokasi_penempatan='$_POST[lokasi_penempatan]',id_varian='$_POST[id_varian]',kode='$_POST[kode]', updated_at='$waktu_sekarang' WHERE id='$_POST[id]'";
	...
	elseif ($act=='updateparameter'){
		$sql="UPDATE master_aset_subkategori_parameter SET nama='$_POST[nama]' , updated_at='$waktu_sekarang'WHERE id='$_POST[id]'";
	...
	elseif($act=='deleteidentitas'){
		...
		$sql="UPDATE  master_aset_subkategori_identitas SET deleted_at='$waktu_sekarang' WHERE id='$_GET[id]'";
		$result=pg_query($conn,$sql);
	...
	elseif($act=='updatevarian'){
		$sql="UPDATE master_aset_subkategori_varian SET nama='$_POST[nama]',keterangan='$_POST[keterangan]', updated_at='$waktu_sekarang' WHERE id='$_POST[id]'";
	...
	elseif($act=='deletevarian'){
		...
		$sql="UPDATE  master_aset_subkategori_varian SET deleted_at='$waktu_sekarang' WHERE id='$_GET[id]'";
		$result=pg_query($conn,$sql);
	...
	elseif($act=='inputkapasitas'){
		$sql="INSERT INTO kapasitas (nama,keterangan,id_subkategori,created_at) VALUES ('$_POST[nama]','$_POST[keterangan]','$_POST[id_subkategori]','$waktu_sekarang')";
		$d=pg_fetch_array(pg_query($conn,$sql));
	...
	elseif($act=='updatekapasitas'){
		$sql="UPDATE kapasitas SET nama='$_POST[nama]',keterangan='$_POST[keterangan]', updated_at='$waktu_sekarang' WHERE id='$_POST[id]'";
	...
	elseif($act=='deletekapasitas'){
		...
		$sql="UPDATE  kapasitas SET deleted_at='$waktu_sekarang' WHERE id='$_GET[id]'";
		$result=pg_query($conn,$sql);
