<form action="aksi-tambah-varian" method="POST" enctype="multipart/form-data">
		...
		<div class="modal-content">
			...
			<div class="modal-body" id="form-data">
                <div class="form-group focused row">
					<label class="form-control-label col-md-3 pt-2">Nama Varian</label>
					<div class="col-md-9">
				...
				<div class="form-group focused row">
					...
					<div class="col-md-9">
						<input type="text"  class="form-control form-control-alternative" placeholder="" name="ketrangan">
					</div>
				</div>
			</div>
