...
if (empty($_SESSION['login_user'])){
	...
	elseif($act=='input'){
		if($_POST['uid_atasan']==''){
			$sql="INSERT INTO master_jabatan(nama, created_at, id_level) VALUES ('$_POST[nama]',  '$waktu_sekarang', '3') RETURNING uid";
		}
		else{
			$sql="INSERT INTO master_jabatan(nama, uid_parent, created_at, id_level) VALUES ('$_POST[nama]', '$_POST[uid_atasan]', '$waktu_sekarang', '3') RETURNING uid";
		}
		$d=pg_fetch_array(pg_query($conn,$sql));
		
		header("location: jabatanlayanan");
	}
