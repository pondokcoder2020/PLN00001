        ...
        <div class="flex">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Jabatan Layanan</li>
                </ol>
            </nav>
            <h3 class="m-0">Jabatan Layanan</h3>
        </div>
            ...
            <div class="table-responsive">
                <table id="example" class="table table-bordered table-striped table-hover" style="width:100%" >
                    ...
                    <tbody>
                        <?php
                        $no=1;
                        $tampil=pg_query($conn,"SELECT uid, nama, uid_parent FROM master_jabatan WHERE deleted_at IS NULL AND id_level='3' ORDER BY nama");
...
<script type="text/javascript" src="addons/js/jabatanlayanan.js"></script>