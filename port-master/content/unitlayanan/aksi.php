...
if (empty($_SESSION['login_user'])){
	...
	elseif($act=='input'){
		$sql="INSERT INTO master_unit (kode, nama, no_telepon, alamat, uid_parent, created_at, id_level) VALUES ('$_POST[kode]', '$_POST[nama]', '$_POST[no_telepon]', '$_POST[alamat]', '5254049b-a5fb-dec7-4e5f-49f634ebc8a7', '$waktu_sekarang', '$_POST[id_level]') RETURNING uid";
